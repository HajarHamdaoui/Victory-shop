...
<div class="row">
    <div class="col-md-10">
        ...
        if(isset($_GET["search_product"])){
            $search_products="select * from `products` where product_keywords  like '%".$_GET['search_input']."%'";
            $result_search=mysqli_query($connect,$search_products);
            $number_of_rows=mysqli_num_rows($result_search);
            if($number_of_rows==0)
            {
              echo "<h3 style='font-weight:800' class = 'text-center text-danger'>No products found try to write specific keywords related to the product </h3>
                ...
                <div class='col-md-4 mb-3'>
                    <div class='card ' style='display:flex;flex-direction:column;align-items:center'>
                        ...
                        <div class='card-body'>
                            ...
                            <a href='view_more_product.php?product=".$row["product_title"]."' class='btn view-button' class='btn view-button'>view more</a>
                        </div>
                    </div>
                </div>
                ";
